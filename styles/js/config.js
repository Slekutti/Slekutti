...
charadex.sheet = {
  ...
  id: "1PvpBUdnBCY4Owy6V_67od_I8CA9lmI-cZpbbNaFPUH0",
  ...
  options: {
    ...
    designTypes: ['All', 'Official Design', 'Guest Design', 'MYO Slot', 'MYO Design','NPCs'],
    statuses: ['All', 'Resell', 'Trade', 'Gift', 'Voided', 'For Sale', 'Purchased','Available','NPC-Status'],
    rarity: ['All', 'Standard','Mutation','Mythical','Crossbreed'],
    species: ['All', 'Slekutti'],
      itemTypes: ['All', 'Currency', 'MYO Slot', 'Creature', 'Trait', 'Misc','Cosmetic'],
    traitTypes: ['All', 'Required','Face','Horns','Body','Wings','Tails','Blade Materials','Ears','Hands']
